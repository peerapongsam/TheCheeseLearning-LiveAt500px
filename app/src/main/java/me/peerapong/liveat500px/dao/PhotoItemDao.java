...
public class PhotoItemDao implements Parcelable {
    ...
    @SerializedName("lens")
    private String lens;
    @SerializedName("focus_lenght")
    private String focusLenght;
    @SerializedName("iso")
    private String iso;
    ...
    public String getFocusLenght() {
        return focusLenght;
    }

    public void setFocusLenght(String focusLenght) {
